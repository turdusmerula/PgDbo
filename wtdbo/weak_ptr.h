 ...
 */
#ifndef DBO_DBO_WEAK_PTR_H_
#define DBO_DBO_WEAK_PTR_H_
...
/*! \class weak_ptr Dbo/weak_ptr Dbo/weak_ptr
 ...
 *
 * A wtdbo::ptr<C> can be converted to a wtdbo::ptr<const C>
