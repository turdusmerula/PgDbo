...
{
	for(StatementMap::iterator i = statementCache_.begin() ; i!=statementCache_.end() ; ++i)
		delete i->second;
...
void SqlConnection::saveStatement(const std::string& id, SqlStatement *statement)
{
...
void SqlConnection::setProperty(const std::string& name, const std::string& value)
{
