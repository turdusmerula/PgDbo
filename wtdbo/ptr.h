 ...
 */
#ifndef DBO_DBO_PTR_H_
#define DBO_DBO_PTR_H_
...
/*! \brief Namespace for the \ref wtdbo
 */
namespace wtdbo
{
...
public:
	enum State
	{
		// wtdbo state (also works with bitwise or)
		New = 0x000,
		Persisted = 0x001,
		Orphaned = 0x002,
...
/*! \class wtdbo_default_traits Dbo/Dbo Dbo/Dbo
...
struct dbo_default_traits
{
	 ...
	 * supported by wtdbo::field() (including composite types) for a
	 * natural primary key.
	 *
...
public:
	...
	virtual Impl::MappingInfo *getMapping();
	virtual void flush();
	...
	void purge();
	void reread();
	virtual void doTransactionDone(bool success);
...
public:
	 ...
	 * wtdbo::dbo_traits<C>::invalidId() if the object is associated
	...
	/*! \brief Returns a wtdbo::ptr to this object.
	 *
...
/*! \defgroup wtdbo Database Objects (Dbo)
 *  \brief An implemenation of an Object Relational Mapping layer.
 *
 * For an introduction, see the <a href="../../tutorial/wtdbo.html">tutorial</a>.
 */

/*! \class ptr Dbo/ptr Dbo/ptr
 ...
 *
 * wtdbo::ptr<const C> can be used when retrieving query results.
...
struct query_result_traits<ptr<C> >
{
	...
	static ptr<C> load(Session& session, SqlStatement& statement, int& column);
