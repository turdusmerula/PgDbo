 ...
 * problems.
 *
 * \sa \link wtdbo::NotNull NotNull\endlink
 * \sa \link wtdbo::OnUpdateCascade OnUpdateCascade\endlink,
 *     \link wtdbo::OnUpdateSetNull OnUpdateSetNull\endlink
 * \sa \link wtdbo::OnDeleteCascade OnDeleteCascade\endlink
 *     \link wtdbo::OnDeleteSetNull OnDeleteSetNull\endlink
 *
 ...
 * wtdbo::dbo_traits to match the type \p V as the IdType for this
 * class. When not specified for a class, an auto-generated surrogate
 * key field is used with the name specified by
 * wtdbo::dbo_traits::surrogateIdField(), which defaults to "id".
 *
 ...
 *
 * For a \link wtdbo::ManyToOne ManyToOne\endlink relation, the
 ...
 * is used.
 *
 * For a \link wtdbo::ManyToMany ManyToMany\endlink relation, the \p
 ...
 * wtdbo::ManyToMany ManyToMany\endlink.
 *
