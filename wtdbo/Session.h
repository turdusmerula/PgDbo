...
public:
	 ...
	 * wtdbo::ptr<User> bart = session.find<User>().where("name = ?").bind("Bart");
	 *
	 ...
	 * an error occurs.
	 *
	 * This method throws an wtdbo::Exception if the table creation failed.
	 *
