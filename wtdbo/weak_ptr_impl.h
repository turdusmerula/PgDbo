 ...
 */
#ifndef DBO_DBO_WEAK_PTR_IMPL_H_
#define DBO_DBO_WEAK_PTR_IMPL_H_
...
typename weak_ptr<C>::accessor weak_ptr<C>::operator->() const
{
	...
	if(!current)
		throw Exception("wtdbo::weak_ptr: null dereference");
...
template<class C>
void weak_ptr<C>::setRelationData(MetaDboBase *dbo, const std::string *sql, Impl::SetInfo *info)
{
...
#endif // DBO_WEAK_WEAK_PTR_IMPL_H_
