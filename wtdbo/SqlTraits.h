 ...
 */
#ifndef DBO_SQL_TRAITS_H_
#define DBO_SQL_TRAITS_H_
 ...
 * wtdbo support for custom types. A value type has a one-to-one mapping
...
struct sql_value_traits
{
	...
	static void bind(const char *v, SqlStatement *statement, int column, int size);
};
...
/*! \class query_result_traits Dbo/SqlTraits Dbo/SqlTraits
