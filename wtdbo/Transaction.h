 ...
 */
#ifndef DBO_TRANSACTION_H_
#define DBO_TRANSACTION_H_
...
/*! \class Transaction Dbo/Transaction Dbo/Transaction
 *  \brief A database transaction.
 * 
 * This class implements a RAII transaction. Most wtdbo manipulations
 ...
 * Usage example:
 * \code
 * void doSomething(wtdbo::Session& session)
 * {
 *   wtdbo::Transaction transaction(session);
 *
 *   wtdbo::ptr<Account> a = session.load<Account>(42);
 *   ...
 *
