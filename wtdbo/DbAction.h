...
{
public:
	DropSchema(Session& session, Impl::MappingInfo& mapping, std::set<std::string>& tablesCreated);
...
{
public:
	LoadBaseAction(MetaDboBase& dbo, Impl::MappingInfo& mapping, SqlStatement *statement, int& column);
...
{
public:
	LoadDbAction(MetaDbo<C>& dbo, Session::Mapping<C>& mapping, SqlStatement *statement, int& column);
...
public:
	...
	SaveBaseAction(MetaDboBase& dbo, Impl::MappingInfo& mapping, SqlStatement *statement = 0, int column = 0);
...
{
public:
	TransactionDoneAction(MetaDboBase& dbo, Session& session, Impl::MappingInfo& mapping, bool success);
...
{
public:
	SetReciproceAction(Session *session, const std::string& joinName, MetaDboBase *value);
