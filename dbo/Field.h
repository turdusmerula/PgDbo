 ...
 * problems.
 *
 * \sa \link dbo::NotNull NotNull\endlink
 * \sa \link dbo::OnUpdateCascade OnUpdateCascade\endlink,
 *     \link dbo::OnUpdateSetNull OnUpdateSetNull\endlink
 * \sa \link dbo::OnDeleteCascade OnDeleteCascade\endlink
 *     \link dbo::OnDeleteSetNull OnDeleteSetNull\endlink
 *
 ...
 *
 * For a \link dbo::ManyToOne ManyToOne\endlink relation, the
 ...
 * is used.
 *
 * For a \link dbo::ManyToMany ManyToMany\endlink relation, the \p
 ...
 * dbo::ManyToMany ManyToMany\endlink.
 *
