...
const char *sql_value_traits<size_t>::type(SqlConnection *conn, int size)
{
	return "double precision not null";
}
...
const char *sql_value_traits<boost::posix_time::ptime>::type(SqlConnection *conn, int size)
{
...
const char *sql_value_traits<boost::posix_time::time_duration>::type(SqlConnection *conn, int size)
{
...
const char *sql_value_traits<std::vector<unsigned char> >::type(SqlConnection *conn, int size)
{
